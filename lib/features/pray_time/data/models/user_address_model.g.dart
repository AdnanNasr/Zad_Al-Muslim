...
void _userAddressModelSerialize(
  ...
  writer.writeString(offsets[1], object.locality);
}
...
UserAddressModel _userAddressModelDeserialize(
  ...
  final object = UserAddressModel(
    ...
    locality: reader.readStringOrNull(offsets[1]),
  );
  object.id = id;
  return object;
}
...
void _userAddressModelAttach(
    IsarCollection<dynamic> col, Id id, UserAddressModel object) {
  object.id = id;
}
...
extension UserAddressModelQueryWhereDistinct
  ...
  QueryBuilder<UserAddressModel, UserAddressModel, QDistinct> distinctByCountry(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
