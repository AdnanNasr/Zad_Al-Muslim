...
class TafseerDownloadNotifier extends StateNotifier<Map<String, TafseerDownloadState>> {
  final Ref ref;
...
final tafsserDownloadProvider = StateNotifierProvider<TafseerDownloadNotifier, Map<String, TafseerDownloadState>>((ref) {
